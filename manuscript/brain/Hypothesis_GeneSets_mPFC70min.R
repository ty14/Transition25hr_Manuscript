...
# wp_sets %>%
#   filter(grepl("WP_GLUCOCORTICOID_RECEPTOR_PATHWAY" ,gs_name,ignore.case = T))%>%
#   select(gene_symbol) %>%  as_tibble() %>%
#   .$gene_symbol -> enx
################## neurotransmission
...
# ggsave("manuscript/brain/imgs/endocrine_70min.png",endo_plot,height =10, width =10, dpi=600)
#
#
...
# ggsave("manuscript/brain/imgs/ATP_metabolic_70min.png",endo_plot,height =10, width =10, dpi=600)
...
#  endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
#  ggsave("manuscript/brain/imgs/RNAMetabolism_70min.png",endo_plot,height =10, width =10, dpi=600)
#fatty acid metabolism
# top<- grid::textGrob("Fatty Acid Metabolism Gene Set", gp = grid::gpar(fontsize = 20))
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/FattyAcidMetabolism_70min.png",endo_plot,height =10, width =10, dpi=600)
#
#glycolysis
# top<- grid::textGrob("Glycolysis Gene Set", gp = grid::gpar(fontsize = 20))
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/GlycolysisMetabolism_70min.png",endo_plot,height =10, width =10, dpi=600)
...
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/CytokineSignaling_70min.png",endo_plot,height =10, width =10, dpi=600)

#inflammation
# top<- grid::textGrob("Neuro Inflammation Gene Set", gp = grid::gpar(fontsize = 20))
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/inflammation_70min.png",endo_plot,height =10, width =10, dpi=600)

# APOPTOSIS
# top<- grid::textGrob("Apoptosis Gene Set", gp = grid::gpar(fontsize = 20))
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/apoptosis_70min.png",endo_plot,height =10, width =10, dpi=600)

#adaptive immune system
# top<- grid::textGrob("Adaptive Immune Gene Set", gp = grid::gpar(fontsize = 20))
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/adapt_immune_70min.png",endo_plot,height =10, width =10, dpi=600)

#innate 
# top<- grid::textGrob("Innate Immune Gene Set", gp = grid::gpar(fontsize = 20))
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/Innate_immune_70min.png",endo_plot,height =10, width =10, dpi=600)
...
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/GluR_70min.png",endo_plot,height =10, width =10, dpi=600)

# CORT
# top<- grid::textGrob("CRHR Signaling Gene Set", gp = grid::gpar(fontsize = 20))
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/Crhr_70min.png",endo_plot,height =10, width =10, dpi=600)

#wnt
# # top<- grid::textGrob("Wnt Signaling Gene Set", gp = grid::gpar(fontsize = 20))
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/Wnt_70min.png",endo_plot,height =10, width =10, dpi=600)
# "WP_ANDROGEN_RECEPTOR_SIGNALING_PATHWAY"
# top<- grid::textGrob("AR Signaling Gene Set", gp = grid::gpar(fontsize = 20))
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/AR_70min.png",endo_plot,height =10, width =10, dpi=600)
...
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/inflamm_Glu_70min.png",endo_plot,height =10, width =10, dpi=600)

# GOBP_RESPONSE_TO_DOPAMINE
# top<- grid::textGrob("Response to Dopamine Gene Set", gp = grid::gpar(fontsize = 20))
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/responseDopamine70min.png",endo_plot,height =10, width =10, dpi=600)

# # GOBP_SYNAPTIC_TRANSMISSION_GABAERGIC
# top<- grid::textGrob("synaptic Transmission GABA Gene Set", gp = grid::gpar(fontsize = 20))
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/ST_GABA70min.png",endo_plot,height =10, width =10, dpi =600)

# GOBP_SYNAPTIC_TRANSMISSION_GLU
# top<- grid::textGrob("synaptic Transmission GLU Gene Set", gp = grid::gpar(fontsize = 20))
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/ST_GLU70min.png",endo_plot,height =10, width =10, dpi =600)
...
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/SecretionofCat70min.png",endo_plot,height =10, width =10, dpi =600)


#DNA repair 
# top<- grid::textGrob("DNA repair", gp = grid::gpar(fontsize = 20))
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/DNARepair70min.png",endo_plot,height =10, width =10, dpi =600)

#bdnf
# top<- grid::textGrob("Bdnf Signaling", gp = grid::gpar(fontsize = 20))
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/Bdnf70min.png",endo_plot,height =10, width =10, dpi =600)

#synaptic signaling 
# top<- grid::textGrob("Synaptic Signaling", gp = grid::gpar(fontsize = 20))
# endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
# ggsave("manuscript/brain/imgs/SS70min.png",endo_plot,height =10, width =10, dpi =600)

#Mitochronia and cellular stress
# "GOBP_CELLULAR_RESPONSE_TO_STRESS"
 # top<- grid::textGrob("Cellular Stress", gp = grid::gpar(fontsize = 20))
 # endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
 # ggsave("manuscript/brain/imgs/CellularStress70min.png",endo_plot,height =10, width =10, dpi =600)

 
 #"GOBP_MITOCHONDRION_ORGANIZATION" 
 # top<- grid::textGrob("Mitochonrion Organization", gp = grid::gpar(fontsize = 20))
 # endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
 # ggsave("manuscript/brain/imgs/MitoOrg70min.png",endo_plot,height =10, width =10, dpi =600)
 
# "WP_MITOCHONDRIAL_COMPLEX_" 
 # top<- grid::textGrob("Mitochonrion Complex I-IV", gp = grid::gpar(fontsize = 20))
 # endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
 # ggsave("manuscript/brain/imgs/MitoComplex70min.png",endo_plot,height =10, width =10, dpi =600)

# "HALLMARK_TNFA_SIGNALING_VIA_NFKB"
 top<- grid::textGrob("TNFA signaling via NFKB", gp = grid::gpar(fontsize = 20))
 endo_plot <- gridExtra::grid.arrange(a,b,c,d, ncol =2, top = top)
 ggsave("manuscript/brain/imgs/TFNA_NFKB70min.png",endo_plot,height =10, width =10, dpi =600)
