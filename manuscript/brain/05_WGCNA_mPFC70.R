...
# saveRDS(datExpr,"manuscript/brain/results/WGCNA_datExpr70.RDS")
# saveRDS(datExprx,"manuscript/brain/results/WGCNA_datExpr70_outliersRemoved.RDS")
...
WGCNA_get_net <- function(my_tissue = "mPFC70min",
  ...
  x <- readRDS("manuscript/brain/results/WGCNA_datExpr70.RDS") 
  set.seed(312)
  ...
  saveRDS(net, "manuscript/brain/results/WGCNA_net_mPFC70_Power5_minmod75.RDS")
...
net <- readRDS(glue::glue("manuscript/brain/results/WGCNA_net_mPFC70_Power5_minmod75.RDS"))
...
png(file = "manuscript/brain/imgs/cluster_dendo_mPFC_Power5_minmod75.png",
...
##################################
set.seed(312)
datExpr <- readRDS("manuscript/brain/results/WGCNA_datExpr70.RDS") 
net <- readRDS("manuscript/brain/results/WGCNA_net_mPFC70_Power5_minmod75.RDS")
dim(datExpr)
...
saveRDS(MEs,"manuscript/brain/results/WGCNA_MEs_mPFC70_Power5.RDS")
...
saveRDS(wgcna_all, "manuscript/brain/results/WGCNA_WGCNA_MM_GS_mPFC70_Power5.RDS")
...
ggsave("manuscript/brain/imgs/sub70_dot.png", sub_dot, width = 7, height = 6)


# TRN modules: pink, turquoise, yellow(?) 
# ASC modules: blue(?) , darkgrey(?), green(?), royalblue(?)
# DES modules: red, grey60(?), cyan(?), dark turquoise(?), magenta(?)
...
write.csv(hubgenes_df, "manuscript/brain/results_tables/WCGNA_hubgene_list_mPFC70_Power5.csv", row.names = F)
...
saveRDS(kIN_df,"manuscript/brain/results/kIN/kIN_dataframe_mPFC_Power5.RDS")
...
write.csv(wgcna_all_gos, 
          "manuscript/brain/results_tables/WGCNA_all_gos_catogeryBP_mPFC70.csv",
          row.names = F)
