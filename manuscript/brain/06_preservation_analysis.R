...
# Start the plot
sizeGrWindow(10, 5)
png("manuscript/brain/imgs/mPFC_-modulePreservation-Zsummary-medianRank.png", wi=10, h=5,units = 'in', res = 300)
par(mfrow = c(1,2))
...
# plot into a pdf file.
 sizeGrWindow(10, 9);
png("manuscript/brain/imgs/mPFC-PreservationZStatistics.png", width=10, height=9,units = 'in', res = 150)
par(mfrow = c(4,4))
par(mar = c(3,3,2,1))
par(mgp = c(1.6, 0.4, 0));
