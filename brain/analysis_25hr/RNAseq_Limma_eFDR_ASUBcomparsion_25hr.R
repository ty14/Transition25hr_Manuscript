...
coldata$mean_con_ng_ul[is.na(coldata$mean_con_ng_ul)] = mean(coldata$mean_con_ng_ul, na.rm =T)
...
ifelse(var_info$condition1 == "Subordinate", 1,-1) -> group.dl
var_info$post_Ncort %>% 
  scale %>% 
  as.numeric -> cort.dl 
...
dge.dl <- d0[-drop,]
dim(dge.dl)
#  14789   12 # how many we have left
...
saveRDS(v.dl, "manuscript/brain/results/limma_vdl_mPFC_25hr_ASUB.RDS")
...
saveRDS(q.dl,("manuscript/brain/results/limma_vdl_cutoff5_2000_tworand_mPFC_25hr_ASUB.RDS"))
q.dl <- readRDS("manuscript/brain/results/limma_vdl_cutoff5_2000_tworand_mPFC_25hr_ASUB.RDS")
...
saveRDS(limma_list,"manuscript/brain/results/limma_mPFC_25hrASUB.RDS")
...
dge.dl <- d0[-drop,]
dim(dge.dl)
#  14761   12 # how many we have left
...
saveRDS(v.dl, "manuscript/brain/results/limma_vdl_MeA_25hr_ASUB.RDS")
# How many random sampling
R = 5000
...
saveRDS(q.dl,("manuscript/brain/results/limma_vdl_cutoff5_2000_tworand_MeA_25hr_ASUB.RDS"))
q.dl <- readRDS("manuscript/brain/results/limma_vdl_cutoff5_2000_tworand_MeA_25hr_ASUB.RDS")
...
saveRDS(limma_list,"manuscript/brain/results/limma_MeA_25hrASUB.RDS")
