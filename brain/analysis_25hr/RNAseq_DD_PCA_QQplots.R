...
dag_sub <- dag[, dag$condition1 %in% c("Dominant", "Descender")]
...
dpg_sub <- dpg[, dpg$condition1 %in% c("Dominant", "Descender")]
...
ggplot(data = d, aes_string(x = "PC1", y = "PC2", color = "group")) +
  ...
  scale_color_manual(values = c("#440154FF", "#2D708EFF"))+
  labs(x = paste0("PC1: ", 
...
ggsave("manuscript/brain/results/results_figures/DD25_MeA_PCA.png",p, dpi=300)
dev.off()
...
ggsave("manuscript/brain/results/results_figures/DD25MeA_QQ.png",p2, dpi=300)
# "#29AF7FFF", "#FDE725FF"
...
ggsave("manuscript/brain/results/results_figures/DD25_mPFCPCA.png",p, dpi=300)
dev.off()
...
ggsave("manuscript/brain/results/results_figures/DD25mPFC_QQ.png",p2, dpi=300)
