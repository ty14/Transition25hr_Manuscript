...
contr.matrix <- makeContrasts(group.dlCSUB-group.dlSUB,
...
saveRDS(v.dl, "brain/results/RDS/limma_vdl_MEA_CSUB.RDS")
...
saveRDS(q.dl,("brain/results/RDS/limma_vdl_cutoff5_2000_tworand_MEA_CSUB.RDS"))
...
topTable(tmp2, sort.by = "P", n = Inf) %>% 
  ...
  left_join(grcm38) %>%
  filter(!is.na(symbol)) %>% 
  dplyr::select(symbol,logFC,P.Value,adj.P.Val)  -> limma_list$casc
...
saveRDS(limma_list,"brain/results/RDS/limma_MEA_CSUB.RDS")
...
saveRDS(v.dl, "brain/results/RDS/limma_vdl_mPFC_CSUB.RDS")
...
saveRDS(q.dl,("brain/results/RDS/limma_vdl_cutoff5_2000_tworand_mPFC_CSUB.RDS"))
...
saveRDS(limma_list,"brain/results/RDS/limma_mPFC_CSUB.RDS")
