...
clust = cutreeStatic(sampleTree, cutHeight = 66, minSize = 10)
table(clust)
...
collectGarbage()
# saveRDS(datExprx,"brain/results/WGCNA/datExpr_mPFC_CSUB_outliersRemoved.RDS")
saveRDS(datExprx,"brain/results/WGCNA/datExpr_mPFC_CSUB.RDS")
# ===========================================================================
...
WGCNA_get_net <- function(my_tissue = "MEA70min",
  ...
  x <- readRDS("brain/results/WGCNA/datExpr_mPFC_CSUB.RDS") 
  ...
  saveRDS(net, "brain/results/WGCNA/net_mPFC_CSUB_Power8.RDS")
  
}

WGCNA_get_net("MEA70min", 8, "signed", "signed hybrid")
# WGCNA_get_net("MEA70min", 7, "signed", "signed hybrid")
# WGCNA_get_net("mPFC70min", 6, "signed", "signed hybrid")
# ========================================================================================

net <- readRDS(glue::glue("brain/results/WGCNA/net_mPFC_CSUB_Power8.RDS"))
...
png(file = "brain/results/img/cluster_dendo_MEA_CSUB_Power8.png",
    width=600, height=350)
plotDendroAndColors(net$dendrograms[[1]], mergedColors[net$blockGenes[[1]]],
                    "Module colors",
                    dendroLabels = FALSE, hang = 0.03,
                    addGuide = TRUE, guideHang = 0.05, 
                    main = "mPFC CSUB Power 8")
...
datExpr <- readRDS("brain/results/WGCNA/datExpr_mPFC_CSUB.RDS") 
net <- readRDS("brain/results/WGCNA/net_mPFC_CSUB_Power6.RDS")
dim(datExpr)
moduleLabels = net$colors
moduleColors = labels2colors(net$colors)
MEs = net$MEs;
...
saveRDS(MEs,"brain/results/WGCNA/mPFC_CSUB_MEs.RDS")
...
png(file = "brain/results/img/module_trait_mPFC_CSUB.png",
    width=800, height=1000, res = 130)
...
saveRDS(wgcna_all, "brain/results/WGCNA/mPFC_CSUB_WGCNA_MM_GS_all.RDS")
...
datExpr <- readRDS("brain/results/WGCNA/datExpr_mPFC_CSUB.RDS") 
net <- readRDS("brain/results/WGCNA/net_mPFC_CSUB_Power6.RDS")
MEs <- readRDS("brain/results/WGCNA/mPFC_CSUB_MEs.RDS")
...
saveRDS(lm_result_all,"brain/results/WGCNA/mPFC_CSUB_lm_result_all.RDS")
...
saveRDS(lm_result_all,"brain/results/WGCNA/mPFC_CSUB_lm_result_all_CORT.RDS")
...
module = "tan"
module_list = c("lightgreen", "lightcyan", "tan", "turquoise", "darkturquoise", "violet", "orange" )
...
write.csv(hubgenes_df, "brain/results/WGCNA/WGCNA_tables/mPFC_CSUB_hubgene_list.csv", row.names = F)
...
saveRDS(kIN_df,"brain/results/WGCNA/kIN/mPFC_CSUB_kIN_dataframe.RDS")
...
write.csv(wgcna_all_gos, 
          "brain/results/wgcna/wgcna_tables/CSUB_mPFC_wgcna_all_gos_catogeryBP.csv",
          row.names = F)
