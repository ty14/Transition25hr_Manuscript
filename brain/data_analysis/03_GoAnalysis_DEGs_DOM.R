...
write.csv(top10_GOterms,"brain/results/tables/topBP_GOterms_MeA_CDOM.csv", row.names = F)
...
rbind(top10go1,top10go2,top10go3) -> top10_GOterms
 ...
 write.csv(top10_GOterms,"brain/results/tables/topBP_GOterms_mPFC_CDOM.csv", row.names = F)
