...
collectGarbage()
saveRDS(datExprx,"brain/results/WGCNA/datExpr_mPFC_CDOM_outliersRemoved.RDS")
saveRDS(datExpr,"brain/results/WGCNA/datExpr_mPFC_CDOM.RDS")
# ===========================================================================
...
WGCNA_get_net <- function(my_tissue = "MEA70min",
  ...
  x <- readRDS("brain/results/WGCNA/datExpr_mPFC_CDOM_outliersRemoved.RDS") 
  ...
  saveRDS(net, "brain/results/WGCNA/net_mPFC_CDOM_Power8_outliersRemoved.RDS")
...
net <- readRDS(glue::glue("brain/results/WGCNA/net_mPFC_CDOM_Power8_outliersRemoved.RDS"))
...
png(file = "brain/results/img/cluster_dendo_mPFC_CDOM_Power8_outliersRemoved.png",
    width=600, height=350)
plotDendroAndColors(net$dendrograms[[1]], mergedColors[net$blockGenes[[1]]],
                    "Module colors",
                    dendroLabels = FALSE, hang = 0.03,
                    addGuide = TRUE, guideHang = 0.05, 
                    main = "mPFC CDOM Power 8")
...
datExpr <- readRDS("brain/results/WGCNA/datExpr_mPFC_CDOM_outliersRemoved.RDS") 
net <- readRDS("brain/results/WGCNA/net_mPFC_CDOM_Power8_outliersRemoved.RDS")
dim(datExpr)
moduleLabels = net$colors
moduleColors = labels2colors(net$colors)
MEs = net$MEs;
...
saveRDS(MEs,"brain/results/WGCNA/mPFC_CDOM_MEs_outliersRemoved.RDS")
...
png(file = "brain/results/img/module_trait_mPFC_CDOM_outlierRemoved.png",
...
labeledHeatmap(Matrix = moduleTraitCor,
               ...
               cex.text = 0.5,
               zlim = c(-1,1),
               main = "CDOM mPFC 70min: Module-trait relationships")
#
#
dev.off()
...
ME_df <-MEs%>% data.frame() %>% 
  ...
  pivot_longer(cols = 2:31, names_to = "Module") %>% 
  full_join(coldata)
...
ggsave(filename = "brain/results/img/mPFC_eigengene_CORT_CDOM_outlierRemoved.png",
       p1,
       height = 13, width = 13, dpi = 130)
...
p2 <- ME_df %>%
  ...
  labs(x = "Social status",
       y = "Module eigengene",
       title = "mPFC: CDOM")+ theme_classic()+ theme(legend.position = "none")

p2

ggsave(filename = "brain/results/img/mPFC_CDOM_eigengene_boxplot_outliersRemoved.png",
       p2,
...
saveRDS(wgcna_all, "brain/results/WGCNA/mPFC_CDOM_WGCNA_MM_GS_all_outliersRemoved.RDS")
...
datExpr <- readRDS("brain/results/WGCNA/datExpr_mPFC_CDOM_outliersRemoved.RDS") 
net <- readRDS("brain/results/WGCNA/net_mPFC_CDOM_Power8_outliersRemoved.RDS")
MEs <- readRDS("brain/results/WGCNA/mPFC_CDOM_MEs_outliersRemoved.RDS")
...
saveRDS(lm_result_all,"brain/results/WGCNA/mPFC_CDOM_lm_result_all_outliersRemoved.RDS")
...
saveRDS(lm_result_all,"brain/results/WGCNA/mPFC_CDOM_lm_result_all_outliersRemoved_CORT.RDS")
...
module_list = c("grey60", "magenta", "purple")
...
write.csv(hubgenes_df, "brain/results/WGCNA/WGCNA_tables/mPFC_CDOM_hubgene_list_outliersRemoved.csv", row.names = F)
...
saveRDS(kIN_df,"brain/results/WGCNA/kIN/mPFC_CDOM_kIN_dataframe_outliersRemoved.RDS")
...
write.csv(wgcna_all_gos, 
          "brain/results/wgcna/wgcna_tables/CDOM_mPFC_wgcna_all_gos_catogeryBP_outliersRemoved.csv",
          row.names = F)
