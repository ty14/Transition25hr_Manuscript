...
a_countdata <- read_csv("brain/AMY_counts.csv")
a_countdata$X -> nrows
...
nrow(dag) # 13925 lost about half
...
dev.off()
ggsave("brain/results/img/CDOM_MEA70_PCA_man.png",p,width = 4.75, height = 4.25, dpi=150)
...
ggsave("brain/results/img/CDOM_mPFC70_PCA_man.png",p1,width = 4.75, height = 4.25, dpi=300)
