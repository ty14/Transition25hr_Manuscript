...
# getting trait data
colnames(coldata)
amy <- coldata[c(3,5,6,13:16,18:20, 22)]
...
saveRDS(datExpr,"manuscript/brain/manuscript70/results/WGCNA/datExpr_MEA_CSUB.RDS")
...
WGCNA_get_net <- function(my_tissue = "MEA70min",
  ...
  x <- readRDS("manuscript/brain/manuscript70/results/WGCNA/datExpr_MEA_CSUB.RDS") 
  ...
  saveRDS(net, "manuscript/brain/manuscript70/results/WGCNA/net_MEA_CSUB_Power10.RDS")
  
}

WGCNA_get_net("MEA70min", 10, "signed", "signed hybrid")
# ========================================================================================

net <- readRDS(glue::glue("manuscript/brain/manuscript70/results/WGCNA/net_MEA_CSUB_Power8.RDS"))
...
png(file = "manuscript/brain/manuscript70/results/results_figures/cluster_dendo_MEA_CSUB_Power10.png",
    width=600, height=350)
plotDendroAndColors(net$dendrograms[[1]], mergedColors[net$blockGenes[[1]]],
                    "Module colors",
                    dendroLabels = FALSE, hang = 0.03,
                    addGuide = TRUE, guideHang = 0.05, 
                    main = "MEA CSUB Power10")
...
saveRDS(MEs,"manuscript/brain/manuscript70/results/wgcna/MEA_CSUB_MEs.RDS")
...
png(file = "manuscript/brain/manuscript70/results/results_figures/module_trait_MEA_CSUB.png",
...
x <- ME_df %>% filter(Module == "grey60")
x <-ME_df %>% filter(Module == "magenta")
x <-ME_df %>%  filter(Module == "brown")
x <-ME_df %>% filter(Module == "green")
...
ggsave(filename = "manuscript/brain/manuscript70/results/results_figures/MEA_eigengene_CORT_CSUB.png",
       p1,
...
x %>%
  ...
  scale_fill_manual(values = c("#f7cb44", "#de7065ff", "#13306dff"))+
   labs(x = "Social status",
       y = "Module eigengene",
       title = "Magenta")+ theme_classic()+ 
  theme(legend.position = "none") 

p2

ggsave(filename = "manuscript/brain/manuscript70/results/results_figures/MEA_CSUB_eigengene_boxplot.png",
       p2,
...
saveRDS(wgcna_all, "manuscript/brain/manuscript70/results/wgcna/MEA_CSUB_WGCNA_MM_GS_all.RDS")
...
module = "darkred"
module = "salmon"
module_list = c("red", "magenta", "pink","brown", "green", "darkred", 'salmon')
...
write.csv(hubgenes_df, "manuscript/brain/manuscript70/results/wgcna/wgcna_table/MEA_CSUB_hubgene_list.csv", row.names = F)
...
saveRDS(kIN_df,"manuscript/brain/manuscript70/results/kIN/MEA_CSUB_kIN_dataframe_.RDS")
...
saveRDS(xz,"manuscript/brain/manuscript70/results/RDS/MEA_CSUB_lm_result_all.RDS")
...
datExpr <- readRDS("manuscript/brain/manuscript70/results/wgcna/datExpr_MEA_CSUB.RDS") 
net <- readRDS("manuscript/brain/manuscript70/results/wgcna/net_MEA_CSUB_Power12.RDS")
...
write.csv(wgcna_all_gos, 
          "manuscript/brain/manuscript70/results/wgcna/wgcna_table/CSUB_MEA_wgcna_all_gos_catogeryBP.csv",
          row.names = F)

saveRDS(wgcna_all_gos,"manuscript/brain/manuscript/results/wgcna/CSUB_MEA_wgcna_all_gos.RDS")
